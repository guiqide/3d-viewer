import { PlaneGeometry, RawShaderMaterial, DoubleSide, Vector2, Color, Mesh, LoadingManager, Box3, Vector3, HemisphereLight, AmbientLight, DirectionalLight, REVISION, Scene, PerspectiveCamera, WebGLRenderer } from 'three';
...
var ThreeDViewer = /** @class */ (function (_super) {
    ...
    function ThreeDViewer(el, options) {
        ...
        _this.defaultCamera = new PerspectiveCamera(fov, aspect, 0.01, 1000);
        ...
        // 镜头控制器
        _this.controls = new OrbitControls(_this.defaultCamera, _this.renderer.domElement);
    ...
    ThreeDViewer.prototype.addLights = function () {
        ...
        var light1 = new AmbientLight(options.ambientColor, options.ambientIntensity);
        light1.name = 'ambient_light';
        this.defaultCamera.add(light1);
        var light2 = new DirectionalLight(options.directColor, options.directIntensity);
