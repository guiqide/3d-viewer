(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('three'), require('three/examples/jsm/loaders/GLTFLoader.js'), require('three/examples/jsm/loaders/DRACOLoader.js'), require('three/examples/jsm/loaders/KTX2Loader.js'), require('three/examples/jsm/controls/OrbitControls.js')) :
	typeof define === 'function' && define.amd ? define(['three', 'three/examples/jsm/loaders/GLTFLoader.js', 'three/examples/jsm/loaders/DRACOLoader.js', 'three/examples/jsm/loaders/KTX2Loader.js', 'three/examples/jsm/controls/OrbitControls.js'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ThreeDViewer = factory(global.THREE, global.GLTFLoader_js, global.DRACOLoader_js, global.KTX2Loader_js, global.OrbitControls_js));
})(this, (function (THREE, GLTFLoader_js, DRACOLoader_js, KTX2Loader_js, OrbitControls_js) { 'use strict';
