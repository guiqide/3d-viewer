(function () {
    ...
    var ___namespace = /*#__PURE__*/_interopNamespace$1(_);
    var THREE__namespace = /*#__PURE__*/_interopNamespace$1(THREE);
    ...
    var Render = /** @class */ (function () {
        function Render(el, options) {
            ...
            this.options = ___namespace.merge({}, options);
            // 镜头控制器
        ...
        Render.prototype.setCamera = function (name) {
            ...
            if (name === DEFAULT_CAMERA) {
                ...
                this.content.traverse(function (node) {
                    if ((node === null || node === void 0 ? void 0 : node.isCamera) && node.name === name) {
    ...
    var threeDViewer = /*#__PURE__*/Object.freeze({
        __proto__: null
    });
    ...
    var render = new threeDViewer(container, options);
    var transferUrl = function (url) {
        return typeof url === 'string'
            ? url
            : URL.createObjectURL(url);
    };
    render.load(transferUrl('./assets/models/skate.glb')).then(function (gltf) {
        console.log(gltf);
    });
    render.render();
